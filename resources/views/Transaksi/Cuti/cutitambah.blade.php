            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Tambah Cuti</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-lg-8">
                                ...
                                <div class="form-group form-group-default">
                                    ...
                                    <input id="jumlah_cuti" type="text" class="form-control" placeholder="Input Jumlah Cuti" @error('jumlah_cuti') is-invalid @enderror name="jumlah_cuti" value="{{ old('jumlah_cuti') }}">
