...
<div class="content">
    <div class="page-inner">
        ...
        <div class="row">
            <div class="col-md-12">
                <form method="POST" action="/lembur">
                    @csrf
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-8">
                                ...
                                <div class="form-group form-group-default">
                                    ...
                                    <input id="jumlah_jam_lembur" type="text" class="form-control" placeholder="Input Jumlah Jam Lembur" @error('jumlah_jam_lembur') is-invalid @enderror name="jumlah_jam_lembur" value="{{ old('jumlah_jam_lembur') }}">
