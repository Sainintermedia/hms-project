...
<div class="content">
    <div class="page-inner">
        ...
        <div class="row">
            <div class="col-md-12">
                <form method="POST" action="/historykenaikangaji">
                    @csrf
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Tambah Hitory Kenaikan Gaji</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-lg-8">
                                ...
                                <div class="form-group form-group-default">
                                    ...
                                    <input id="gaji_pokok_lama" type="text" class="form-control" placeholder="Input Gaji Pokok lama" @error('gaji_pokok_lama') is-invalid @enderror name="gaji_pokok_lama" value="{{ old('gaji_pokok_lama') }}">
                                    @error('gaji_pokok_lama')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>

                                <div class="form-group form-group-default">
                                    <label>Persentase Kenaikan</label>
                                    <input id="persentase_kenaikan" type="text" class="form-control" placeholder="Input Persentase Kenaikan" @error('persentase_kenaikan') is-invalid @enderror name="persentase_kenaikan" value="{{ old('persentase_kenaikan') }}">
                                    @error('persentase_kenaikan')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>

                                <div class="form-group form-group-default">
                                    <label>Gaji Pokok Baru</label>
                                    <input id="gaji_pokok_baru" type="text" class="form-control" placeholder="Input Gaji Pokok baru" @error('gaji_pokok_baru') is-invalid @enderror name="gaji_pokok_baru" value="{{ old('gaji_pokok_baru') }}">
